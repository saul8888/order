...
type MongoDB interface {
	ConnectDB() error
	DisconnectDB() error
	GetByID(locationID string) (*mongo.SingleResult, error)
	...
	Update(locationID string, params interface{}) (model.Location, error)
...
// GetByID method
func (repo *Mongodb) GetByID(locationID string) (*mongo.SingleResult, error) {
...
// Update method
func (repo *Mongodb) Update(locationID string, params interface{}) (model.Location, error) {
	...
	err = collection.FindOneAndUpdate(ctx, filter, update, opts).Decode(&updatedLocation)

	return updatedLocation, err
}

// Delete method
func (repo *Mongodb) Delete(locationID string) error {
	collection := repo.db.Collection(defaultCollectionName)
