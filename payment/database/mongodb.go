...
type MongoDB interface {
	ConnectDB() error
	DisconnectDB() error
	GetByID(paymentID string) (*mongo.SingleResult, error)
	...
	Update(paymentID string, params interface{}) (model.Payment, error)
...
// GetByID method
func (repo *Mongodb) GetByID(paymentID string) (*mongo.SingleResult, error) {
...
// Update method
func (repo *Mongodb) Update(paymentID string, params interface{}) (model.Payment, error) {
	...
	err = collection.FindOneAndUpdate(ctx, filter, update, opts).Decode(&updatedPayment)

	return updatedPayment, err
}

// Delete method
func (repo *Mongodb) Delete(paymentID string) error {
	collection := repo.db.Collection(defaultCollectionName)
